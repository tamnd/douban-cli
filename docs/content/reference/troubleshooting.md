...
Most of these come down to network reality or how douban-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

douban-cli rate-limits like any public site. douban already paces
...
Where a surface is gated, douban reads a cookie or token you supply
...
`douban`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what douban actually did
